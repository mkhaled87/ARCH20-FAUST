...
dim = 3;   % Write here the dimension of the model
dim_u = 2;  % Write here the dimension of the input
...
A = [0.578 0.2 0.2;0.2 0.578 0.2;0.2 0.2 0.578];
B = [2.5 0;0 0;0 2.5];
Sigma = 0.05*eye(3);
% vectorized manipulation
E_xbar = A*x_vec + B*u_vec -0.0220;
